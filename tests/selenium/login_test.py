"""
login_test.py (Selenium)
=========================
Sample end-to-end test: logs into SauceDemo using the Selenium engine and
verifies a successful redirect to the inventory ("Products") page.

Run with:
    pytest tests/selenium/login_test.py -m selenium
(ensure config.yaml -> execution_engine: "selenium")
"""
...
from core.base.selenium_base_test import SeleniumBaseTest
...
@pytest.mark.smoke
class TestSeleniumLogin(SeleniumBaseTest):
    """Smoke test suite for SauceDemo authentication (Selenium engine)."""
